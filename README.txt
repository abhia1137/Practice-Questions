...
#### Input source
__Contacts API - version: 1.2.0__

An API for keeping track of your contacts and the companies they work for. 
...
The list of user-specific authentication mechanism for contactsAPI is the following:
